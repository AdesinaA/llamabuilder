      ...
      <main className="mt-12 flex w-full flex-1 flex-col items-center px-4 text-center sm:mt-20">
        ...
        >
          <span className="text-center">
            Built with <span className="font-medium">Llama 3.1, Gemma 2 </span> and{" "}
            <span className="font-medium">Together AI</span>
          </span>
        </a>
        <h1 className="my-6 max-w-3xl text-4xl font-bold text-gray-800 sm:text-6xl">
          Build<span className="text-green-600"> an app</span>
          <br /> with your <span className="text-green-600">idea</span>
        </h1>
          ...
          <fieldset disabled={loading} className="disabled:opacity-75">
              ...
              <div className="relative flex rounded-3xl bg-white shadow-sm">
                <div className="relative flex flex-grow items-stretch focus-within:z-10">
                  <input
                    ...
                    placeholder="Build a music application..."
                  />
                </div>
                <button
                  type="submit"
            ...
            <div className="mt-6 flex flex-col justify-center gap-4 sm:flex-row sm:items-center sm:gap-8">
              <div className="flex items-center justify-between gap-3 sm:justify-center">
                ...
                >
                  <Select.Trigger className="group flex w-60 max-w-xs items-center rounded-2xl border-[6px] border-gray-300 bg-white px-4 py-2 text-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-green-500">
                    <Select.Value />
              ...
              <div className="flex h-full items-center justify-between gap-3 sm:justify-center">
                ...
                <Switch.Root
                  className="group flex w-20 max-w-xs items-center rounded-2xl border-[6px] border-gray-300 bg-white p-1.5 text-sm shadow-inner transition focus-visible:outline focus-visible:outline-2 focus-visible:outline-green-500 data-[state=checked]:bg-green-500"
                  id="shadcn"
                  name="shadcn"
                  checked={shadcn}
                  ...
                  <Tooltip.Root>
                    <Tooltip.Trigger asChild>
                      <button
                        ...
                        className="inline-flex h-[68px] w-40 items-center justify-center gap-2 rounded-3xl bg-green-500 transition enabled:hover:bg-green-600 disabled:grayscale"
                      >
